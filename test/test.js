...
var _user$project$Polyline$stringFromCode = function (code) {
...
var _user$project$Polyline$encodeCoordinateShift = function (coordinate) {
	return (_elm_lang$core$Native_Utils.cmp(coordinate, 32) > -1) ? A2(
		_elm_lang$core$Basics_ops['++'],
		_user$project$Polyline$stringFromCode(
			A2(
				_elm_lang$core$Bitwise$or,
				32,
				A2(_elm_lang$core$Bitwise$and, coordinate, 31)) + 63),
		_user$project$Polyline$encodeCoordinateShift(
			A2(_elm_lang$core$Bitwise$shiftRight, coordinate, 5))) : _user$project$Polyline$stringFromCode(coordinate + 63);
};
...
var Elm = {};
Elm['Test'] = Elm['Test'] || {};
Elm['Test']['Polyline'] = Elm['Test']['Polyline'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Test']['Polyline'], 'Test.Polyline', typeof _user$project$Test_Polyline$main === 'undefined' ? null : _user$project$Test_Polyline$main);
